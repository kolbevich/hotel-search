...
import 'tests/hotel_screen_empty_test.dart' as tests__hotel_screen_empty_test;
import 'tests/hotel_search_test.dart' as tests__hotel_search_test;
import 'tests/search_and_tab_change_test.dart' as tests__search_and_tab_change_test;
import 'tests/search_scroll_test.dart' as tests__search_scroll_test;
import 'tests/unfavorite_test.dart' as tests__unfavorite_test;
...
Future<void> main() async {
  ...
  group('tests.hotel_screen_empty_test', tests__hotel_screen_empty_test.main);
  group('tests.hotel_search_test', tests__hotel_search_test.main);
  group('tests.search_and_tab_change_test', tests__search_and_tab_change_test.main);
  group('tests.search_scroll_test', tests__search_scroll_test.main);
  group('tests.unfavorite_test', tests__unfavorite_test.main);
